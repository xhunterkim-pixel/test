...
/// and kept in %AppData%\CustomTradersEditor\icons, so they show instantly afterwards and
/// also offline. Items tarkov.dev doesn't have (modded items) are remembered for a week.
/// </summary>
public static class ItemIcons
{
    private static readonly string Folder = Path.Combine(Settings.Folder, "icons");
    ...
    static ItemIcons() => Http.DefaultRequestHeaders.UserAgent.ParseAdd("Mozilla/5.0 (Windows NT 10.0; Win64; x64) CustomTradersEditor/1.0");
